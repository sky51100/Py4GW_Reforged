...
def main() -> None:
    ...
    tree.tick()
    tree.UI.draw_window(icon_path=TEXTURE, iconwidth=96, main_child_dimensions=(420, 380), extra_tabs=[('Statistics', _draw_statistics), ('Party', _dungeon_party.draw_tab), ('Config', _draw_run_config)])
